...
const startuserverification = async (client, budy, from, mek, sender, palavroes, spamcheker, usersjson, text, sticker, isGroup, isFakenews, reply) => {
    ...
    if (usermensagem.length > 100) {
        ...
        if (ispcheck > 3) return reply('Percebi que você enviou um codigo! Poderia estar utilizando por gentileza, esta ferramenta para que nós possamos estar lendo melhor o seu código?\nhttps://carbon.now.sh/')
    }
