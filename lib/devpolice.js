...
const add = (isGroup, isGroupAdmins, client, from, isBotGroupAdmins, args, isQuotedVcard, isQuotedMessage, mek, reply) => {
    client.updatePresence(from, Presence.composing)
    if (verifiuser(isOwner, isGroup, isGroupAdmins, isBotGroupAdmins, reply)) {
        if (isQuotedVcard) {
...
const kick = (isGroup, mess, isOwner, isGroupAdmins, client, from, isBotGroupAdmins, isQuotedMessage, mek, mentions, text, reply) => {
    if (verifiuser(isOwner, isGroup, isGroupAdmins, isBotGroupAdmins, reply)) {
        client.updatePresence(from, Presence.composing)
        if (isQuotedMessage) {
            var numbertoadd = mek.message.extendedTextMessage.contextInfo.participant
...
const getallusers = (client, from, mess, isOwner, isGroup, isGroupAdmins, isBotGroupAdmins, isUser, usersjson, text, extendedText, mek, reply) => {
    if (verifiuser(isOwner, isGroup, isGroupAdmins, isBotGroupAdmins, reply)) {
...
const startuserverification = async (client, budy, from, mek, sender, palavroes, palavraspam, usersjson, text, isGroup, reply) => {
    ...
    if (usermensagem.length > 600) {
        if (usermensagem.length > 6500) {
            ...
            wordcheck = checapalavrasspam(usermensagem, palavraspam)
