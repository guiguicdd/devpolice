...
const linkdogrupo = async (usermensagem) => {
    let prograwords = ["link desse grupo", "tem o link do grupo", "enviar o link do grupo", "link daqui do grupo", "the group link", "the group url", "link desse grupo?", "tem o link do grupo?", "enviar o link do grupo?", "link daqui do grupo?", "the group link?", "the group url?"]
    let i = 0
    let result = ''
